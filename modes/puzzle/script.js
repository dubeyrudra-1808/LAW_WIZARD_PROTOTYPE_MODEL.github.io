var images = ['https://kaybeeexports.com/wp-content/uploads/2020/08/image045-1-e1597060584302.jpg'];
...
function drop(ev) {
  ...
  if (ev.target.className == data) {
    ...
    if (document.querySelectorAll('.dropped').length == 9) {
      ...
      // Pop a message in red after all images are placed correctly
      var winMessage = document.getElementById('winMessage');
      winMessage.innerHTML = "Say No To Child-Labour.";
      winMessage.style.color = "red";
      winMessage.style.fontSize = "50px";

      // Add the message-pop-up class to trigger the animation
      winMessage.classList.add('message-pop-up');
    }
  }
}